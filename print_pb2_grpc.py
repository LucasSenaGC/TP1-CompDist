...
class MutualExclusionServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.RequestAccess = channel.unary_unary(
                ...
                request_serializer=print__pb2.AccessRequest.SerializeToString,
                response_deserializer=print__pb2.AccessResponse.FromString,
                _registered_method=True)
        self.ReleaseAccess = channel.unary_unary(
                '/distributed_printing.MutualExclusionService/ReleaseAccess',
                request_serializer=print__pb2.AccessRelease.SerializeToString,
                response_deserializer=print__pb2.Empty.FromString,
                _registered_method=True)
...
def add_MutualExclusionServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'RequestAccess': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=print__pb2.AccessRequest.FromString,
                    response_serializer=print__pb2.AccessResponse.SerializeToString,
            ),
            'ReleaseAccess': grpc.unary_unary_rpc_method_handler(
                    servicer.ReleaseAccess,
                    request_deserializer=print__pb2.AccessRelease.FromString,
                    response_serializer=print__pb2.Empty.SerializeToString,
            ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
...
class MutualExclusionService(object):
    ...
    def RequestAccess(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/distributed_printing.MutualExclusionService/RequestAccess',
            print__pb2.AccessRequest.SerializeToString,
            print__pb2.AccessResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def ReleaseAccess(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/distributed_printing.MutualExclusionService/ReleaseAccess',
            print__pb2.AccessRelease.SerializeToString,
            print__pb2.Empty.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
